...
export const MODAL_IDS = {
  ...
  INVENTORY_COTIZADO_PROVEEDORES: "inventoryCotizadoProveedores",
  INVENTORY_BONIFICACIONES: "inventoryBonificaciones",
  INVENTORY_WIP: "inventoryWip",
  INVENTORY_PIEZAS_SURTIDAS: "inventoryPiezasSurtidas",
  INVENTORY_PIEZAS: "inventoryPiezas",
  INVENTORY_HABILITACIONES_PENDIENTES: "inventoryHabilitacionesPendientes",
  INVENTORY_DOCUMENTOS: "inventoryDocumentos",
  INVENTORY_CURVA_TMP: "inventoryCurvaTmp",
  INVENTORY_CURVA_2: "inventoryCurva2",

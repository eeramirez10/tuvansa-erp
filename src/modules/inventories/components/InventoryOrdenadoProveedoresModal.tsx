...
function InventoryOrdenadoProveedoresModal() {
  ...
  return (
    <ManagedWindowLayer windowId={MODAL_IDS.INVENTORY_ORDENADO_PROVEEDORES} isOpen={isOpen}>
      <section className="flex h-[min(560px,78vh)] w-[min(1420px,98vw)] flex-col border border-[#2f8ce8] bg-[#ececec]">
        ...
        <div className="relative modal-scroll min-h-0 flex-1 overflow-auto border-b border-[#9ca3ab]">
          ...
          {isLoading ? <LegacyModalLoader label="Cargando ordenado a proveedores..." /> : null}
          {error ? (
